...
},{"object-assign":"../../node_modules/react/node_modules/object-assign/index.js","prop-types/checkPropTypes":"../../node_modules/react/node_modules/prop-types/checkPropTypes.js"}],"../../node_modules/react/index.js":[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":"../../node_modules/react/cjs/react.development.js"}],"../../node_modules/isomorphic-fetch/node_modules/whatwg-fetch/fetch.js":[function(require,module,exports) {
"use strict";
...
},{"whatwg-fetch":"../../node_modules/isomorphic-fetch/node_modules/whatwg-fetch/fetch.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var App = function (_Component) {
  ...
  function App(props, context) {
    ...
    _this.onChange = function (e) {
      _this.setState({
        keysword: e.target.value
      });
    };

    _this.search = function () {
      var keysword = _this.state.keysword;
      console.log(keysword, 'keyword');

      if (keysword.length !== 0) {
        var url = 'http://127.0.0.1:3000/autocomplete/' + keysword;
        (0, _isomorphicFetch.default)(url).then(function (res) {
          return res.json();
        }).then(function (res) {
          _this.setState({
            hots: res
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var _this$state = this.state,
          hots = _this$state.hots,
          keysword = _this$state.keysword;
      return _react.default.createElement("div", {
        className: "main"
      }, _react.default.createElement("h2", {
        className: "title"
      }, "\u77E5\u4E4E\u641C\u7D22"), _react.default.createElement("section", {
        ...
        className: "hot",
        style: {
          display: keysword.length > 0 ? 'block' : 'none'
        }
      }, _react.default.createElement("ul", null, hots.map(function (item, index) {
        return _react.default.createElement("li", {
          key: index,
          onClick: function onClick(_) {
            return window.open('https://www.zhihu.com/question/' + item.id);
          }
        }, _react.default.createElement("span", null, item.text), _react.default.createElement("span", null, item.count, " \u4E2A\u56DE\u7B54"));
...
},{"react":"../../node_modules/react/index.js","isomorphic-fetch":"../../node_modules/isomorphic-fetch/fetch-npm-browserify.js"}],"../../node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)